...
class InstaBot:
    def __init__(self):
        ...
        sleep(2)
        self.driver.find_element_by_xpath("//input[@name=\"username\"]").send_keys("Your_Details")
        self.driver.find_element_by_xpath("//input[@name=\"password\"]").send_keys("Your_Details")
